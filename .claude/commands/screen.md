...
Read first:
1. `docs/spec/06-screens.md` (or `07-canvas.md`) — the region-by-region table
...
- Apply the role cut from `docs/spec/03-personas-roles.md` at the **selector** level, not by
